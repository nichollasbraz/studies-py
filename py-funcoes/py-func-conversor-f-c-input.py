def aluguel_carros(dias):
    aluguel_diario = dias * 129.99
    ...
    if dias >= 30:
        ...
        print("Desconto de 15%(-{:.2f}): R${:.2f}".format(aluguel_desconto_1, total_aluguel))
    
    elif dias >= 7:
        total_aluguel = aluguel_diario - aluguel_desconto_2
        print("\nMontante: R${:.2f}".format(aluguel_diario))
        print("Desconto de 5%(-{:.2f}): R${:.2f}".format(aluguel_desconto_2, total_aluguel))
    
    else:
        total_aluguel = aluguel_diario
        print("\nMontante: R${:.2f}".format(total_aluguel))

dias = int(input("Insira a quantidade de dias que o automóvel será alugado: "))
